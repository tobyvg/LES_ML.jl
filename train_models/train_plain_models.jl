...
for I in Is
    ...
    save_NN_model(model,"./models/plain_"*"$I"*"/plain_model")
    save("./models/plain_"*"$I"*"/losses.jld","losses",losses)
    save("./models/plain_"*"$I"*"/relative_losses.jld","relative_losses",relative_losses)
end